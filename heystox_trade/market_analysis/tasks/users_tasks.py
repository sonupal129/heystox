...
@periodic_task(run_every=(crontab(day_of_month=1, hour=8, minute=40)),queue="default", options={"queue": "default"})
...
@periodic_task(run_every=(crontab(day_of_week="2-6", hour=8, minute=55)),queue="default", options={"queue": "default"})
...
@periodic_task(run_every=(crontab(day_of_week="2-6", hour=2, minute=5)),queue="default", options={"queue": "default"})    
...
@periodic_task(run_every=(crontab(day_of_week="1-5", hour=7, minute=30)),queue="default", options={"queue": "default"})
