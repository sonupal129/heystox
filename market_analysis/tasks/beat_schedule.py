...
day_trading_tasks = {
    ...
    # "restart_websocket": {
    #     "task": "market_analysis.tasks.day_trading_tasks.restart_websocket",
    #     "schedule": crontab(day_of_week="1-5", hour="9-15", minute="*/15"),
    # },
    # "find_ohl_stocks": {
...
orders = {
    "cancel_not_executed_orders": {
        ...
        "schedule": crontab(day_of_week="1-5", hour="10-14", minute="*/10"),
        "kwargs": {"from_last_minutes": 30},
    },
